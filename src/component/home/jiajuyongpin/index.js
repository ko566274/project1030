...
class Jiajuyongpin extends Component{
	constructor(){
		super();
		this.state={
			looplist:[]
  ...
  render(){
    return <div id="jiaju">
	    ...
	    <div className="bannertitle">
		    ...
		    <div className="jsqjfooter">
	    		<a href="/home/jiajuyongpin">查看全部</a>
	    	</div>
	    </div>
	    <div className="modle">
   ...
   componentDidMount(){
   	...
   	axios.get("/v2/page?pageId=1&tabId=10006&_=1541141449314").then(res=>{
